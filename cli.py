...
def run(number, dexdate, apksize, vtdetection, pkgname, markets, metadata, out, seed, sha256):
    ...
    *criteria_args, metadata = Parser(dexdate, apksize, vtdetection, markets, pkgname, metadata, sha256).parse()
