...
class Criteria(Entity):
    ...
    def __init__(self, dex_date_from=None, dex_date_to=None, apk_size_from=None, apk_size_to=None, vt_detection_from=None, vt_detection_to=None, markets=None, pkg_name=None, sha256=None, sha1=None):
    ...
    def _key(self):
        return self.dex_date, self.apk_size, self.vt_detection, self.markets, self.pkg_name, self.sha256, self.sha1

    def __str__(self):
        return f'dex_date={self.dex_date}, apk_size={self.apk_size}, vt_detection={self.vt_detection}, markets={self.markets}, pkg_name={self.pkg_name}, sha256={self.sha256}, sha1={self.sha1}'
